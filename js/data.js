...
(function (window) {
  ...
  var DEFAULT_DATA = {
    ...
    team: [
      { id: 'team-1', name: 'EBUBEKİR KAPLAN', role: 'İSG KATİP MESUL MÜDÜR', photo: '/img/team-1.webp' },
      { id: 'team-2', name: 'EMRE GÜLTEKİN', role: 'FİNANS UZMANI', photo: '/img/team-2.webp' },
      { id: 'team-3', name: 'Süleyman Atalay', role: 'Satın Alma ve İdari İşler Müdürü', photo: '/img/team-3.webp' },
      { id: 'team-4', name: 'TAMER ÇEKECEKER', role: 'GENEL MÜDÜR', photo: '/img/team-4.webp' },
      { id: 'team-5', name: 'ERTUGRUL IŞIK', role: 'YÖNETİM KURUL BAŞKANI', photo: '/img/team-5.webp' },
      { id: 'team-6', name: 'ESRA KURT', role: 'SÜREÇ YÖNETİM UZMANI', photo: '/img/team-6.webp' },
      { id: 'team-7', name: 'DİLAN ŞEN', role: 'YÖNETİCİ ASİSTAN', photo: '/img/team-7.webp' },
      { id: 'team-8', name: 'NURCAN ÖKTEM', role: 'İNSAN KAYNAKLAR SORUMLUSU', photo: '/img/team-8.webp' },
      { id: 'team-9', name: 'AHMET HAKAN YEŞİL', role: 'SATIŞ PAZARLAMA MÜDÜRÜ', photo: '/img/team-9.webp' },
      { id: 'team-10', name: 'ÖMER DEMİRCAN', role: 'BİLGİ İŞLEM SORUMLUSU', photo: '/img/team-10.webp' },
      { id: 'team-11', name: 'SERAP KAYA', role: 'MUHASEBE SORUMLUSU', photo: '/img/team-11.webp' }
    ]
  };
  ...
  var Store = {
    ...
    // Sayfa içerikleri HTML'e statik olarak gömülüdür; JS ile yeniden
    // çizim yalnızca yönetim panelinden kayıt yapılmış tarayıcılarda olur.
